...
// Form state using our custom useForm
const form = useForm({
    customer_id: '',
    items: [],
});
...
const loadInitialData = async () => {
    ...
    try {
        ...
        // Extract array from paginator or take as is
        ...
        // Only display active products with stock
        products.value = rawProds.filter(p => p.is_active && p.stock > 0);
    } catch (error) {
        notify('Error al cargar datos para el pedido.', 'error');
    } finally {
        loading.value = false;
    }
};
...
const submitOrder = () => {
    // Map cart state to backend request structure
    ...
    form.post('/orders', {
        onSuccess: (data) => {
            notify('Pedido creado con éxito en Bolivianos (Bs.).');
            router.push('/orders');
        },
        onError: (errs) => {
            const globalErr = errs.global || 'Error al procesar el pedido. Revise el stock de los productos.';
            notify(globalErr, 'error');
        }
    });
};
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div v-if="form.errors && Object.keys(form.errors).length > 0" class="mb-6 rounded-md bg-rose-50 p-4 border border-rose-200">
                    <div class="flex">
                ...
                <div v-if="loading" class="text-center py-12 text-gray-500">
                    Cargando catálogo e información del sistema...
                </div>
                        ...
                        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg border border-gray-100 p-6">
                            ...
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 max-h-[400px] overflow-y-auto pr-1">
                                ...
                                >
                                    ...
                                    <div class="flex items-center justify-between mt-3 pt-3 border-t border-gray-55">
                        ...
                        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg border border-gray-100 p-6 flex flex-col h-full min-h-[500px] justify-between">
                            ...
                            <div class="border-t border-gray-100 pt-4 mt-6 space-y-4">
                                ...
                                <div class="bg-gray-50 rounded-md p-3 text-[11px] text-gray-500">
                                    * Los precios finales se recalculan estrictamente en el servidor utilizando los datos oficiales del inventario.
                                </div>
